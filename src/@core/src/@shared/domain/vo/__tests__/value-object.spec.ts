...
describe("value object unit tests", () => {
    ...
    it("shoud set value", () => {
        ...
        let vo = new StubValueObject(expectedValue);
        expect(vo).toBeInstanceOf(ValueObject);
        expect(vo.value).toBe(expectedValue);

        const expectedObject = {name: "teste name"};
        vo = new StubValueObject(expectedObject);
        expect(vo).toBeInstanceOf(ValueObject);
        expect(vo.value.name).toBe(expectedObject.name);
    })
